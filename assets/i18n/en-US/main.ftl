...
settings-mac-controls = macOS-style controls
settings-mac-controls-detail = Draw minimise, maximise and close as colored dots
settings-rounded-window = Rounded window
settings-rounded-window-detail = Round the window corners
