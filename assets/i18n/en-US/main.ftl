...
menu-transfer-playlist = Transfer to { $name }
...
mixes-heavy-rotation = Heavy rotation
mixes-recent-discoveries = Recent discoveries
mixes-short-sweet = Short & sweet
mixes-forgotten-favorites = Forgotten favorites
...
settings-lastfm-detail = Send the tracks you play to your Last.fm profile
settings-lastfm-connected = Connected as { $name }
settings-lastfm-connect = Connect
settings-lastfm-disconnect = Disconnect
settings-lastfm-cancel = Cancel
settings-lastfm-waiting = Waiting for approval in the browser…
settings-lastfm-enable = Enable scrobbling
settings-lastfm-enable-detail = Record plays on Last.fm while connected
...
toast-transfer-unavailable = Connect another provider or set up Local Music to transfer playlists
toast-transfer-playlist-done = Transferred { $name }
toast-transfer-playlist-failed = Playlist could not be transferred
