...
nav-library-recents = Нещодавні
kind-audiobook = Аудіокнига
kind-podcast = Подкаст
kind-folder = Папка

nav-library-added = Нещодавно додані
nav-library-alphabetical = За абеткою
...
nav-pin-spotify = Закріпити у Spotify
nav-unpin-spotify = Відкріпити у Spotify

nav-sidebar-library = Бібліотека в бічній панелі
nav-return-top = Повернутися нагору
