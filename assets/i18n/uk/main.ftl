...
settings-mac-controls = Кнопки у стилі macOS
settings-mac-controls-detail = Малювати згорнути, розгорнути та закрити як кольорові крапки
settings-rounded-window = Заокруглене вікно
settings-rounded-window-detail = Заокруглити кути вікна
