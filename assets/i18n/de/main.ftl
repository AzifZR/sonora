...
settings-mac-controls = Steuerung im macOS-Stil
settings-mac-controls-detail = Minimieren, Maximieren und Schließen als farbige Punkte zeichnen
settings-rounded-window = Abgerundetes Fenster
settings-rounded-window-detail = Fensterecken abrunden
