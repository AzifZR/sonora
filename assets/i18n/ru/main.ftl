...
settings-mac-controls = Кнопки в стиле macOS
settings-mac-controls-detail = Рисовать свернуть, развернуть и закрыть как цветные точки
settings-rounded-window = Скруглённое окно
settings-rounded-window-detail = Скруглить углы окна
