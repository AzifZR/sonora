...
settings-mac-controls = Controles al estilo macOS
settings-mac-controls-detail = Dibuja minimizar, maximizar y cerrar como puntos de colores
settings-rounded-window = Ventana redondeada
settings-rounded-window-detail = Redondea las esquinas de la ventana
