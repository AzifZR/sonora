...
settings-mac-controls = Contrôles façon macOS
settings-mac-controls-detail = Dessiner réduire, agrandir et fermer sous forme de points colorés
settings-rounded-window = Fenêtre arrondie
settings-rounded-window-detail = Arrondir les coins de la fenêtre
