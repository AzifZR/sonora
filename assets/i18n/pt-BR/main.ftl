...
settings-mac-controls = Botões estilo macOS
settings-mac-controls-detail = Desenhar minimizar, maximizar e fechar como pontos coloridos
settings-rounded-window = Janela arredondada
settings-rounded-window-detail = Arredondar os cantos da janela
