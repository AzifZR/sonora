...
settings-mac-controls = Przyciski w stylu macOS
settings-mac-controls-detail = Rysuj minimalizację, maksymalizację i zamknięcie jako kolorowe kropki
settings-rounded-window = Zaokrąglone okno
settings-rounded-window-detail = Zaokrąglij rogi okna
