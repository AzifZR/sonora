...
settings-mac-controls = macOS風コントロール
settings-mac-controls-detail = 最小化・最大化・閉じるを色付きドットで表示する
settings-rounded-window = 角丸ウィンドウ
settings-rounded-window-detail = ウィンドウの角を丸くする
